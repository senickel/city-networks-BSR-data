url <- "http://en.wikipedia.org/wiki/List_of_twin_towns_and_sister_cities_in_Finland"
web_page <- readLines(url)
wstart<-grep("<h2><span class=\"mw-headline\" id=\"Espoo\">Espoo",web_page)
...
write.csv(citycountry,"data/PARTNERCITIES-FINLAND.csv")
##edited - load again
citycountry2<-read.csv("data/PARTNERCITIES-FINLAND.csv",colClasses = "character")
...
citycom
write.csv(citycom,"data/PARTNERCITIES Finland.csv")